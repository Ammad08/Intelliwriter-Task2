...
deleteSpeed:40
  ...
  return (
    <>
    <main className=" bg-gradient-to-t from-[#0F062C] to-[#3c0881]">
      ...
      >
        <div className=" pt-24 min-h-screen flex flex-col items-center justify-center text-white font-sans">
          <div className="text-center px-5 md:px-20 md:mt-15 mt-10">
      ...
      <button className="border-8 border-gray-800 rounded-xl   bg-gradient-to-r from-[#6B41FF] to-[#EE4BFF] px-6 py-3 flex items-center space-x-2 justify-center text-center">
          <img
            src="btnlogo.svg"
        ...
        <button className="z-50 fixed   tic right-2 bottom-[15%] md:bottom-[10%] w-8 h-8 md:w-16 md:h-16  border-4 border-[#7b1fa2]  bg-[#ffff00] !text-black rounded-full flex items-center justify-center">
        <svg
          stroke="currentColor"
          fill="currentColor"
          strokeWidth="0"
          viewBox="0 0 512 512"
          className="text-[#7b1fa2]  text-[24px] "
          height="1em"
          width="1em"
